...
function ViewProfile_AllJuniorAdvocates() {
    ...
    const handleActivate = (id) => {
        axiosInstance.post(`/activateJuniorAdvocateById/${id}`)
            .then(res => {
    ...
    const handleDeactivate = (id) => {
        axiosInstance.post(`/deactivateJuniorAdvocateById/${id}`)
            .then(res => {
                if (res.data.status === 200) {
                        ...
                        <div>
                            <table className="table ju-custom-table">
                                <tbody>
                                    ...
                                    {advocate.isActive ? (
                                        <button
                                            className="btn btn-outline-danger ju-button-size1"
                                        ...
                                        <button
                                            className="btn btn-outline-success ju-button-size1"
...
export default ViewProfile_AllJuniorAdvocates;
